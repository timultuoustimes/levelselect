...
export const SAYONARA_CONFIG = {
  ...
  chapters: [
    ...
    { id: 'swh-5',  name: '5. Heartbreak II',          items: [] },
    { id: 'swh-6',  name: '6. Forest Ghost',           items: [] },
    { id: 'swh-7',  name: '7. Forest Dub',             items: [] },
    { id: 'swh-8',  name: '8. Laser Love',             items: [] },
    { id: 'swh-9',  name: '9. Heartbreak III',         items: [] },
