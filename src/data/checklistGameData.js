...
export const SAYONARA_CONFIG = {
  ...
  hasRanks: true,
  chapters: [
    { id: 'swh-1',  name: '1. Clair De Lune',          items: [] },
    { id: 'swh-2',  name: '2. Heartbreak',             items: [] },
    { id: 'swh-3',  name: '3. Doki Doki Rush',         items: [] },
    { id: 'swh-4',  name: '4. Fighting Hearts',        items: [] },
    { id: 'swh-5',  name: '5. Begin Again',            items: [] },
    { id: 'swh-6',  name: '6. Heartbreak II',          items: [] },
    { id: 'swh-7',  name: '7. Forest Ghost',           items: [] },
    { id: 'swh-8',  name: '8. Forest Dub',             items: [] },
    { id: 'swh-9',  name: '9. Laser Love',             items: [] },
    { id: 'swh-10',  name: '10. Dead of Night',       items: [] },
    { id: 'swh-11', name: '11. Heartbreak III',         items: [] },
    { id: 'swh-12', name: '12. Hearts & Swords',       items: [] },
    { id: 'swh-13', name: '13. Parallel Universes',    items: [] },
    { id: 'swh-14', name: '14. Mine',                  items: [] },
    { id: 'swh-15', name: '15. Heartbreak IV',         items: [] },
    { id: 'swh-16', name: '16. Night Drift',           items: [] },
    { id: 'swh-17', name: '17. Reverie',               items: [] },
    { id: 'swh-18', name: '18. The World We Knew',     items: [] },
    { id: 'swh-19', name: '19. Heartbreak V',          items: [] },
    { id: 'swh-20', name: '20. Transonic Gravity',     items: [] },
    { id: 'swh-21', name: '21. Hate Skulls',           items: [] },
    { id: 'swh-22', name: '22. Iniside',               items: [] },
    { id: 'swh-23', name: '23. Wild Hearts Never Die', items: [] },
    { id: 'swh-24', name: '24. Album Arcade', items: [] },
    { id: 'swh-25', name: '25. Yolo Arcade', items: [] },
    ],
};
